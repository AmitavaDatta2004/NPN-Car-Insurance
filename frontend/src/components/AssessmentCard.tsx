  ...
  if (isFraud) {
    return (
      <div className="space-y-6">
        <div className="rounded-2xl border border-rose-200 bg-rose-50/70 p-8 shadow-sm text-center">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-rose-100 text-rose-700 text-2xl font-bold">
            !
          </div>
          <span className="text-xs font-bold uppercase tracking-wider text-rose-600">
            Claim Status
          </span>
          <h2 className="text-2xl font-black tracking-tight text-rose-950 mt-1">
            Fraud Detected
          </h2>
          <p className="mt-3 text-sm text-slate-700 leading-relaxed max-w-xl mx-auto">
            This claim has been flagged for review. It is currently at the adjuster end and will be reviewed manually. Automated damage assessment and repair estimation have been suspended.
          </p>
        </div>
      </div>
    );
