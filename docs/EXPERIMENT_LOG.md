...
| SEV-VIT-001 | 2026-09-22 | Member 4 / Antigravity | pending commit | Car Damage Severity v1 / severity_train.csv, _val.csv, _test.csv | ViT-Tiny (DualStream GeM Pool, 224x224) | 42 | COMPLETE | Test Acc: 64.92% / Macro F1: 0.6450 / 81.9% adjacent err | artifacts/models/severity_vit.pt | ACCEPTED (Phase 7 Gate passed, 5-stage progression) |
