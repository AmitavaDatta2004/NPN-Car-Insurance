    ...
    cells = [
        ...
        # Cell 10: Stage B Fine-Tuning
        {
            ...
            "source": [
                ...
                "    raise RuntimeError('No validated Stage A checkpoint')\n",
                "model.load_state_dict(best_model_state)\n",
                "\n",
                "CHECKPOINT_PATH = REPO_ROOT / 'ml' / 'artifacts' / 'severity' / 'severity_mnv2_v1.pt'\n",
                "CHECKPOINT_PATH.parent.mkdir(parents=True, exist_ok=True)\n",
                "save_severity_checkpoint(model=model, save_path=CHECKPOINT_PATH, epoch=best_epoch,\n",
                "                         metrics={'val_macro_f1': best_val_f1})\n",
                "\n",
